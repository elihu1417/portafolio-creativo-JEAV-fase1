...
export default function NuevoProyectoPage() {
  ...
  const handleSubmit = async (isPublished: boolean) => {
    ...
    try {
      ...
      setError(err.message || 'Error al crear el proyecto. Por favor, intenta de nuevo.')
      ...
      <div className="container mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <h1 className="text-3xl font-bold">
            Nuevo Proyecto: <span className="font-normal">{projectTitle || '[Sin título]'}</span>
          </h1>
                        ...
                        <div className="space-y-3">
                          <div className="relative">
                            <input
                              type="file"
                              accept="image/*"
                              disabled={uploadingBlockImage === block.id || loading}
                              onChange={(e) => {
                                const file = e.target.files?.[0]
            ...
            <div className="space-y-4">
              <div>
                ...
                {imagenPortadaUrl && !uploadingPortada && (
                  <div className="mt-2">
                    <p className="text-xs text-green-400 mb-2">✓ Imagen subida correctamente</p>
                    <img
              ...
              <div>
                ...
                <input
                  type="file"
                  accept="image/*"
                  disabled={loading || uploadingPrincipal}
