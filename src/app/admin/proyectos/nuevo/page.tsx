    ...
    <div className="bg-gray-800 text-brand-text font-sans min-h-screen">
      ...
      <header className="bg-gray-900 shadow-md sticky top-0 z-10">
        <div className="container mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <span className="text-xs font-semibold px-2 py-1 rounded-full bg-yellow-600 text-white">
            Borrador
          </span>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-xl">
            ...
            <div className="min-h-[300px] border-2 border-dashed border-gray-600 p-4 rounded mb-6 bg-gray-800 flex items-center justify-center">
